        ...
        <div className="field-array">
          <div className={multiTable ? "source-record-list is-multi" : "source-record-list"}>
            ...
            {properties.map((property, index) => {
              ...
              const numeric = text(property.valueType) === "DECIMAL";
              ...
              return (
                ...
                >
                  ...
                  <span className={numeric ? "type-unit has-unit" : "type-unit"}>
                    <select aria-label="属性类型" value={text(property.valueType)} onChange={(event) => updateProperty(index, { valueType: event.target.value })}>
            ...
            <div className="try-read">
              ...
              {preview ? (
                <p className="mapping-hint">
                  草稿预览 · {previewOutcomeText(text(focused.provider), preview.kind, preview.reason)}
